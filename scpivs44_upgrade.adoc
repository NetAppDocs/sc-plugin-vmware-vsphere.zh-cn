...
NOTE: 升级到 SCV 6.2 仅在 VMware vCenter Server 7 update 1 和更高版本上受支持，对于 VMware vCenter Server 版本 7 update 1 之前的版本，您应继续使用 SCV 4.7。在不受支持的 VMware vCenter Server 版本上，升级会造成中断。
...
要了解有关受支持版本的最新信息，请参阅 link:https://imt.netapp.com/imt/imt.jsp?components=180121;&solution=1517&isHWU&src=IMT["NetApp 互操作性表工具（ IMT ）"^]。
