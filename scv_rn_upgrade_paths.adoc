...
---
= SnapCenter Plug-in for VMware vSphere 的升级路径
:allow-uri-read: 
...
[NOTE]
====
升级到 SnapCenter Plug-in for VMware vSphere (SCV) 4.8 及更高版本仅在 VMware vCenter Server 7 update 1 及更高版本上受支持。对于版本 7 update 1 之前的 VMware vCenter Server，应继续使用 SCV 4.7。
