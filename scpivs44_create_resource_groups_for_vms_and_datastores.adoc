...
+*要为一个VM创建资源组、请单击*菜单*>*主机和集群*、然后右键单击一个VM、选择NetApp SnapCenter 、然后单击 image:scpivs44_image6.png["错误：缺少图形映像"] * 创建资源组 * 。*要为一个数据存储库创建资源组、请单击*菜单*>*主机和集群*、然后右键单击一个数据存储库、选择* NetApp SnapCenter *、然后单击 image:scpivs44_image6.png["错误：缺少图形映像"] * 创建资源组 * 。
