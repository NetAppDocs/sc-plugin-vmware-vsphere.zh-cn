...
有关更多信息，请参阅适用ONTAP tools for VMware vSphere文档。如需了解支持的版本，请访问 https://imt.netapp.com/matrix/imt.jsp?components=134348;&solution=1517&isHWU&src=IMT["NetApp 互操作性表工具"^]。
